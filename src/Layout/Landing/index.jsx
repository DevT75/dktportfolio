        ...
        <div className='flex container origin-left flex-col justify-between items-center w-full h-full transition-all duration-200 ease-out'>
            ...
            <div className='flex flex-row justify-around items-center w-full h-[65%]'>
                <div className='w-[45%] flex flex-col justify-center items-center'>
                    <Image src={'/assets/rayquaza.jpg'} alt='charizard' width={150} height={160} />
                </div>
...
const BottomCard = () => {
    return (
        <div className='container origin-right flex flex-col-reverse justify-between items-center w-full h-full'>
            <div className='w-full h-[20%] lg:h-[15%] border-t-4 border-b-4 border-black'>
                <div className='w-full h-full bg-blue-600 flex flex-row gap-1 md:gap-2 py-4 px-2 justify-around items-center'>
                    <div className='flex flex-1 flex-row justify-center items-center uppercase py-3 px-1.5 rounded-md border border-blue-600 border-dashed bg-white text-[12px] group'>
                    <FaCaretLeft />
                        <span>Track</span>
                    </div>
                    <div className='flex flex-1 flex-row justify-center items-center uppercase py-3 px-1.5 rounded-md border border-blue-600 border-dashed bg-white text-[12px]'>Details</div>
                    <div className='flex flex-1 flex-row justify-center items-center uppercase py-3 px-1.5 rounded-md border border-blue-600 border-dashed bg-white text-[12px]'>stats</div>
                    <div className='flex flex-1 flex-row justify-center items-center uppercase py-3 px-1.5 rounded-md border border-blue-600 border-dashed bg-white text-[12px]'>Exit</div>
                </div>
            </div>
        </div>
    )
...
export const LandingPage = () => {
    return (
        <div className="poke-font flex flex-col lg:flex-row w-full gap-2 h-full justify-center items-center bg-pokeball-sm bg-center transition-all duration-300 ease-out bg-cover lg:bg-pokeball-lg">
            <div className='relative origin-left transition-all duration-500 ease-out bg-white border-black w-[85%] h-[43%] md:w-[70%] md:h-[45%] lg:w-[43%] lg:h-[65%]'>
                <TopCard />
            </div>
            <div className='relative origin-right transition-all duration-500 ease-out bg-white border-black w-[85%] h-[43%] md:w-[70%] md:h-[45%] lg:w-[43%] lg:h-[65%]'>
                <BottomCard />
            </div>
        </div>
    )
